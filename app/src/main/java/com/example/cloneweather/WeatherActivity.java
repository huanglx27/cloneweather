package com.example.cloneweather;
...
import com.example.cloneweather.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forcastLayout = (LinearLayout) findViewById(R.id.forcecast_layout);
        aqiText = (TextView) findViewById(R.id.aqi_text);
        pm25Text = (TextView) findViewById(R.id.pm25_text);
        comfortTest = (TextView) findViewById(R.id.comfort_text);
        ...
        if(weatherString != null){
            ...
            showWeatherInfo(weather);//有缓存直接解析天气数据；
        }
        else {
            mWeatherId = getIntent().getStringExtra("weather_id");
            weatherLayout.setVisibility(View.INVISIBLE);
            requestWeather(mWeatherId);//无缓存去服务器查询天气
        }
